-- Tahu production schema for InfinityFree MySQL/MariaDB.
-- Select the InfinityFree database in phpMyAdmin before importing.
-- Do NOT include CREATE DATABASE or USE statements here.
